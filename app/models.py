...
class Zoho_Invoice(Base):
    ...
    business_id = Column(String,ForeignKey('organisations.business_id'),primary_key=True)
    invoice_id = Column(String,nullable=False,primary_key=True,unique=True)
...
# for r in result:
#     print(r.business_id,r.irn)
# conn = engine.connect()

# insert_statement = organisation.insert().values(business_id='dfk235',tin='009-234-13',
#                                                 name='Medhelp247 Limited',
#                                                 telephone='+2348033072664',
#                                                 email='takinnibosun@gmail.com',
#                                                 business_description='Consulting')

# select_statement = organisation.select()
# update_statement = organisation.update().where(organisation.c.name == 'Medhelp247 Limited').values(business_description = 'Telemedicine company')

...
from fastapi import Depends,HTTPException, Query,status,Response,APIRouter,Form,Request
...
async def callback(code: str, location: str, accounts_server: str = Query(..., alias="accounts-server")):
    """
